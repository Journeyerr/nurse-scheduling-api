...
public interface ExpectScheduleMapper extends BaseMapper<ExpectSchedule> {
     ...
     * @return 期望列表
     */
    List<ExpectScheduleResponse> getExpectScheduleList(@Param("departmentId") Long departmentId);
     ...
     * @return 期望列表
     */
    List<ExpectScheduleResponse> getMyExpectSchedule(@Param("userId") Long userId);
